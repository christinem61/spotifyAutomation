...
from credentials import spotify_token, spotify_user_id
...
class CreatePlaylist:
    ...
    def get_youtube_client(self):
        ...
        # Creating API client w credentials
    ...
    def get_liked_videos(self):
        # Get liked vids and make dict Of important song info
        ...
        # cget video and get important information
        for item in response["items"]:
            video_title = item["snippet"]["title"]
            youtube_url = "https://www.youtube.com/watch?v={}".format(item["id"])

            # use youtube_dl to collect get song name & artist name
    ...
    def get_spotify_uri(self, song_name, artist):
        ...
        song_name = song_name.replace('Lyric','')
